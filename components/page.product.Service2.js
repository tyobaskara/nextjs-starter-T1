...
export default class Service2 extends PureComponent {
  constructor(props){
    super(props);
    ...
    return content.length > 0 ? (
      <div className='product-right'>
        ...
        <div className='product-body'>
          ...
          <div className='product-icon-list service-2'>
            <div className='wrapper'>
              {this._renderIconList()}
              <Image 
                className="product-icon-list__main"
                src='/static/images/Service2-main-icon.jpg'
                alt='dhealth service 2'
              />
            </div>
          </div>
