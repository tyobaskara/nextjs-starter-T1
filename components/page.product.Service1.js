...
export default class Service1 extends PureComponent {
  constructor(props){
    super(props);
    ...
    return content.length > 0 ? (
      <div className='product-right'>
        ...
        <div className='product-body'>
          ...
          <div className='product-icon-list service-1'>
            <div className='wrapper'>
              {this._renderIconList()}
              <Image 
                className="product-icon-list__main"
                src='/static/images/Service1-main-icon.jpg'
                alt='dhealth service 1'
              />
            </div>
          </div>
