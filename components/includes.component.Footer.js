...
class Footer extends PureComponent {
  ...
  _renderSectionAbout = () => {
    ...
    return (
      <div className='col-6 col-md-3'>
        <p className='footer-title'>{this.props.t('about')}</p>
        <ul>
  ...
  _renderSectionProduct = () => {
    ...
    return (
      <div className='col-6 col-md-3'>
        <p className='footer-title'>{this.props.t('products')}</p>
        <ul>
  ...
  _renderSectionContact = () => {
    ...
    return (
      <div className='col-12 col-md-6'>
        <p className='footer-title'>{this.props.t('contact')}</p>
